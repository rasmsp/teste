...
export default function Form(props) {
  ...
  function onInputChange(e) {
    ...
    if (id === 'currencyCode') {
      ...
      const extension = Function.extentionFile(value[0].name);
      if (
  ...
  function onSave() {
    ...
    if (values.cardDate === undefined || values.cardDate.length < 10) {
      alert('Informe o campo "Data do comprovante"!');
      return;
    }
    if (values.amountSpent === undefined || values.amountSpent === '0,00') {
      alert('Informe o campo "Valor a ser considerado"!');
      return;
    }
    if (values.amountTotal === undefined || values.amountTotal === '0,00') {
    ...
    formData.append('expenseTypeCode', values.expenseTypeCode);
    ...
    formData.append('resourceUrl', values.file);
